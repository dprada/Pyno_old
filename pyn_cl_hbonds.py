...
###def pseudbonds_pack (system1=None,select1=None,system2=None,select2=None,verbose=True):
###    
###    pack_done=True
### 
###    if select2!=None and system2==None : 
...
###            if system1.atom[ii].acceptor: 
###                ind_acc1.append(ii+1)
###            if tp.residue_type[system1.atom[ii].resid.name]=='Ion':
###                if system1.atom[ii].charge>0.0: ind_cation1.append(ii+1)
###                if system1.atom[ii].charge<0.0: ind_anion1.append(ii+1)
### 
###        for ii in select2:
###            if system2.atom[ii].donor: 
###                ind_don2.append(ii+1)
...
###            if system2.atom[ii].acceptor: 
###                ind_acc2.append(ii+1)
###            if tp.residue_type[system2.atom[ii].resid.name]=='Ion':
###                if system2.atom[ii].charge>0.0: ind_cation2.append(ii+1)
###                if system2.atom[ii].charge<0.0: ind_anion2.append(ii+1)
### 
### 
###        same_set=False
### 
...
###            if tp.residue_type[system1.atom[ii].resid.name]=='Ion':
###                if system1.atom[ii].charge>0.0: ind_cation1.append(ii+1)
###                if system1.atom[ii].charge<0.0: ind_anion2.append(ii+1)
###            if system1.atom[ii].donor:
###                ind_don1.append(ii+1)
###                ind_Hdon1.append(system1.donors_hydrogen[ii])
###                num_Hdon1.append(len(system1.donors_hydrogen[ii]))
...
###        same_set=True
### 
###    f_hb.hbonds.lcat1=len(ind_cation1)
###    f_hb.hbonds.lani1=len(ind_anion1)
###    f_hb.hbonds.lcat2=len(ind_cation2)
###    f_hb.hbonds.lani2=len(ind_anion2)
###    f_hb.hbonds.ldon1=len(ind_don1)
###    f_hb.hbonds.lacc1=len(ind_acc1)
###    f_hb.hbonds.ldon2=len(ind_don2)
###    f_hb.hbonds.lacc2=len(ind_acc2)
...
###    f_hb.hbonds.initialize_memory_in()
### 
###    f_hb.hbonds.ind_cat1=array(ind_cation1,dtype=int,order='Fortran')
###    f_hb.hbonds.ind_ani1=array(ind_anion1,dtype=int,order='Fortran')
###    f_hb.hbonds.ind_don1=array(ind_don1,dtype=int,order='Fortran')
###    f_hb.hbonds.num_hdon1=array(num_Hdon1,dtype=int,order='Fortran')
###    f_hb.hbonds.ind_acc1=array(ind_acc1,dtype=int,order='Fortran')
###    f_hb.hbonds.ind_cat2=array(ind_cation2,dtype=int,order='Fortran')
###    f_hb.hbonds.ind_ani2=array(ind_anion2,dtype=int,order='Fortran')
###    f_hb.hbonds.ind_don2=array(ind_don2,dtype=int,order='Fortran')
###    f_hb.hbonds.ind_acc2=array(ind_acc2,dtype=int,order='Fortran')
###    f_hb.hbonds.num_hdon2=array(num_Hdon2,dtype=int,order='Fortran')
### 
...
###            f_hb.hbonds.ind_hdon2[i,j]=ind_Hdon2[i][j]+1
### 
###    del(ind_don1,ind_Hdon1,num_Hdon1,ind_acc1,ind_cation1,ind_anion1)
###    del(ind_don2,ind_Hdon2,num_Hdon2,ind_acc2,ind_cation2,ind_anion2)
### 
###    if verbose:
###        return pack_done,same_set
###                    
...
### 
### 
###def pseudobonds_ions(system1=None,select1=None,system2=None,select2=None,box=None,r_param=3.5,ang_param=30.0,pack=None,verbose=False):
### 
###    if pack :
###        same_set=pack[1]
###    else:
